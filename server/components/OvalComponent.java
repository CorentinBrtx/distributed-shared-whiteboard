...
public class OvalComponent extends Ellipse2D.Double implements DSComponent {
	...
	public OvalComponent(int x1, int y1, int x2, int y2, Color color, int thickness) {
	...
	public boolean contains(double x, double y) {
		...
		return this.getFrame().contains(x, y);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof OvalComponent) {
			return this.id.equals(((OvalComponent) obj).id);
		} else {
			return false;
		}
	}
